...
public class AssignmentController {
    ...
    public ResponseEntity<Assignment> createAssignment(@RequestBody Assignment assignment) {
    	URI uri = URI.create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/v1/assignments").toUriString());
    ...
    public ResponseEntity<Assignment> updateBatchDetails(@PathVariable Long assignmentId, @RequestBody Assignment updatedAssignment) {
