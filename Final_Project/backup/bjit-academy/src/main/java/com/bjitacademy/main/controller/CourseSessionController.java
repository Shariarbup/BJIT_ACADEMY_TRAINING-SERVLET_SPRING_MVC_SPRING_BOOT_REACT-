...
public class CourseSessionController {
    ...
    public ResponseEntity<CourseSession> createCourseSession(@RequestBody CourseSession courseSession) {
    	URI uri = URI.create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/v1/courseSessions").toUriString());
    ...
    public ResponseEntity<CourseSession> updateCourseSessionDetails(@PathVariable Long courseSessionId, @RequestBody CourseSession updatedCourseSession) {
