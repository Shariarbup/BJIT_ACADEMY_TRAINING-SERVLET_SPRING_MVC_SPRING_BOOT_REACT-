  ...
  return (
    <div className='container'>
          ...
          <div className='row m-3'>
            ...
            <div className='col-4'><button type="button" class="btn btn-primary btn-lg btn-block"><Link className='text-white' to='/trainer/courses'>All Courses</Link></button></div>
          </div>
          <div className='row m-3'>
