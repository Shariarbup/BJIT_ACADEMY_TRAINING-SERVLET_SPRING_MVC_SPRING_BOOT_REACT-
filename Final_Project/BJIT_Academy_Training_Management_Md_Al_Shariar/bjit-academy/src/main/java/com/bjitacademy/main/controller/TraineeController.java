...
public class TraineeController {
	...
	public ResponseEntity<List<Trainee>> getTraineeByBatchId(@PathVariable Long batchId) {
		return ResponseEntity.ok().body(traineeService.getTraineeByBatchId(batchId));
	}
	...
	public ResponseEntity<Trainee> updateTraineeDetails(@PathVariable Long traineeId,
			@RequestBody Trainee updatedTrainee) {
