...
public class TrainerController {
	...
	public ResponseEntity<Trainer> createTrainer(@RequestBody Trainer trainer) {
		URI uri = URI
				.create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/v1/trainers").toUriString());
	...
	public ResponseEntity<Trainer> updateTrainerDetails(@PathVariable Long trainerId,
