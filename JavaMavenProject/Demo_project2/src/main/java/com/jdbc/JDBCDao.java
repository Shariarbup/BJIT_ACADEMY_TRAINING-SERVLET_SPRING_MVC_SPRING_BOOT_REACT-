...
public class JDBCDao {
	...
	public void insertData() { // date format i have changed from '10/09/2013' to '2013/05/11'
		String sql = "";
		sql = "INSERT INTO exam (exam_name,total_question,valid_from,valid_to) VALUES ( 'Java Fundamentals', 10,'2013/05/11', '2013/10/01')";
		execUpdateSQL(sql);

		sql = "INSERT INTO exam ( exam_name,total_question,valid_from,valid_to) VALUES ( 'Java Maven',10, '2013/05/11', '2013/10/01')";
		execUpdateSQL(sql);
		
		sql = "INSERT INTO exam ( exam_name,total_question,valid_from,valid_to) VALUES ( 'ICT',5, '2013/05/11', '2013/10/01')";
		execUpdateSQL(sql);
		
		sql = "INSERT INTO exam ( exam_name,total_question,valid_from,valid_to) VALUES ( 'Math',6, '2013/05/11', '2013/10/01')";
		execUpdateSQL(sql);
	}
